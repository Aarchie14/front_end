            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  />
                  <Eye className="absolute right-3 top-1/2 -translate-y-1/2 w-[22px] h-5 opacity-50 text-[#18345e]" />
                </div>
              </div>
              ...
              {/* Password Matching Notice */}
              <div className="flex items-center space-x-2">
                <input type="radio" id="agree" className="w-4 h-4" />
